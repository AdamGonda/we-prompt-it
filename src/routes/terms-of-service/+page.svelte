<svelte:head>
	<title>Terms of service | We Prompt</title>
</svelte:head>
...
<p>
	...
	and use your personal information. If you do not agree with these terms, please do not use
	our Service. We encourage you to read and understand these agreements before using our Service.
</p>

<h2>1. Registration and Acces</h2>
<p>
	You must be at least 13 years old to use the Services. If you are under 18 you must have
	your parent or legal guardian's permission to use the Services. If you use the Services
	on behalf of another person or entity, you must have the authority to accept the Terms
	on their behalf. You must provide accurate and complete information to register for an
	account. You may not make your access credentials or account available to others outside
	your organization, and you are responsible for all activities that occur using your
	credentials.
</p>

<h2>2. User Responsibilities</h2>
<p>
	As a user of 'We Prompt', you agree not to use the Service to do anything unlawful,
	misleading, malicious, or discriminatory. You are responsible for all your activities
	while using the Service, including all legal, regulatory, and financial responsibility
	for your actions.
</p>

<h2>3. Rights and Licenses</h2>
<p>
...
<p>
	...
	functionality are and will remain the exclusive property of 'We Prompt' and its
	licensors.
</p>
...
<p>
	...
	Services. You are responsible for protecting those rights. We take no responsibility and
	assume no liability for Content you or any third party posts on or through the Service.
	However, by posting Content using the Service, you grant us the right to remove any
	Content that we, at our sole discretion, find to be in violation of these Terms or any
	applicable laws.
</p>
...
<p>
	...
	controlled by 'We Prompt'. 'We Prompt' has no control over, and assumes no
	responsibility for, the content, privacy policies, or practices of any third-party
	websites or services. You further acknowledge and agree that 'We Prompt' shall not be
	responsible or liable, directly or indirectly, for any damage or loss caused or alleged
	to be caused by or in connection with the use of or reliance on any such content, goods,
...
<p>
	...
	terminate your account, you may simply discontinue using the Service. All provisions of
	...
	and limitations of liability. Please note that upon termination of your account, any
	associated content and data may be deleted. We are not responsible for the loss of such
	content.
</p>

<h2>9. Dispute Resolution</h2>
<p>
	Any disputes arising out of the use of our Services will be governed by the laws of
	Hungary without regard to its conflict of law provisions.
</p>
...
<p>
	...
	non-infringement, or course of performance. In no event shall 'We Prompt', nor its
	...
	conduct or content of any third party on the Service; (iii) any content obtained from
	the Service; and (iv) unauthorized access, use, or alteration of your transmissions or
